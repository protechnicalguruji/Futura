    ...
    <section id="home" className="relative min-h-screen flex items-center pt-20">
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <p className="text-xl text-gray-light font-light mb-8 max-w-lg">Premium real estate solutions built on trust, transparency, and long-term value.</p>
        </motion.div>
        ...
        >
          <div className="grid grid-cols-2 gap-4 mb-4">
            <input required type="text" placeholder="Full Name" className="bg-transparent border border-white/20 p-3 rounded-lg text-sm focus:border-gold outline-none" onChange={(e) => setFormData({...formData, name: e.target.value})} />
            <input required type="text" placeholder="Phone Number" className="bg-transparent border border-white/20 p-3 rounded-lg text-sm focus:border-gold outline-none" onChange={(e) => setFormData({...formData, phone: e.target.value})} />
          </div>
