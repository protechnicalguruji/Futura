    ...
    <section className="py-[140px] bg-bg-body">
      <div className="max-w-[1440px] mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
        <div className="relative group">
          <img src="/images/consultation_interior.jpg" alt="Consultation" className="w-full h-[700px] object-cover rounded-[28px] shadow-2xl" />
          <div className="absolute bottom-10 left-10 right-10 bg-white/90 backdrop-blur-md p-10 rounded-[28px] shadow-2xl space-y-6">
        ...
        <div className="bg-white p-12 rounded-[28px] border border-border shadow-2xl">
          <span className="text-accent font-medium tracking-widest uppercase text-[15px] mb-4 block">Let's Connect</span>
          <h2 className="font-serif text-[48px] leading-[1.1] mb-10 tracking-tighter">Let's Find Your Perfect Investment.</h2>
